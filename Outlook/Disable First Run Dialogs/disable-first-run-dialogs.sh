...
Purpose: Command to disable the Microsoft Outlook First Run Setup dialogs
...
defaults write "/Library/Preferences/com.microsoft.Outlook.plist" FirstRunExperienceCompleted015 -bool TRUE
defaults write "/Library/Preferences/com.microsoft.Outlook.plist" OUIWhatsNewLastShownLink -string 624956
